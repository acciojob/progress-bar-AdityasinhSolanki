...
nextButton.addEventListener('click', () => {
    if (currentStep < totalSteps) {
        ...
        document.querySelectorAll('.line')[currentStep - 1].classList.add('active');
        currentStep++;
        updateButtons();
    }
});
...
prevButton.addEventListener('click', () => {
    if (currentStep > 1) {
        ...
        document.querySelectorAll('.line')[currentStep - 1].classList.remove('active');
        updateButtons();
    }
});
